...
namespace Rikrop.Core.Wpf.Behaviors
{
    public class UiElementHandleEventsBehaviour : Freezable
    {
        ...
        private void UnSubscribeHandleMouseDown()
        {
            ...
            WeakEventManager<UIElement, MouseButtonEventArgs>.RemoveHandler(_ue, "MouseDown", UeOnMouseDown);
        }
        ...
        private void SubscribeHandleMouseDown()
        {
            ...
            WeakEventManager<UIElement, MouseButtonEventArgs>.AddHandler(_ue, "MouseDown", UeOnMouseDown);
        }

...
namespace Rikrop.Core.Wpf.Mvvm.ValueEditing
{
    ...
    public interface IValueEditorHandler : INotifyPropertyChanged //Unsupported in 4.0, INotifyDataErrorInfo
    {
    ...
    namespace Contracts
    {
        ...
        public abstract class ContractIValueEditorHandler : IValueEditorHandler
        {
            ...
            //Unsupported in 4.0, public abstract event EventHandler<DataErrorsChangedEventArgs> ErrorsChanged;

...
namespace Rikrop.Core.Wpf.Collections
{
    public class CollectionManager<TItem> : ChangeNotifier, ICollectionManager<TItem>
    {
        ...
        private readonly IItemLoader<IList<TItem>> _loader;
        ...
        public CollectionManager(ObservableCollection<TItem> targetCollection, IItemLoader<IList<TItem>> loader, bool isAutoLoading)
        {

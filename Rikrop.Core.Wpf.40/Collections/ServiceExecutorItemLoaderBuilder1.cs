...
namespace Rikrop.Core.Wpf.Collections
{
    public class ServiceExecutorItemLoaderBuilder1<TService, TItem>
    {
        ...
        public ServiceExecutorItemLoaderBuilder2<TService, TItem> LoadWith(Func<TService, Task<IList<TItem>>> itemsLoaderFunc)
        {
    ...
    public class ServiceExecutorItemLoaderBuilder1<TService, TServiceItem, TItem>
    {
        ...
        public ServiceExecutorItemLoaderBuilder2<TService, TServiceItem, TItem> LoadWith(Func<TService, Task<IList<TServiceItem>>> itemsLoaderFunc)
        {
